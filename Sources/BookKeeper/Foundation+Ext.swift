...
public extension Dictionary {
    /// Returns a Boolean value indicating whether the property of Dictionary Value at a given keyPath
    /// contains given value.
    /// - Parameters:
    ///   - prop: value to look for.
    ///   - keyPath: keyPath.
    /// - Returns: `true` if the Dictionary Values contains an element with property of a value
    /// (at keyPath); otherwise, `false`.
...
public extension Array {
    ...
    func keyedBy<T: Hashable>(keyPath: KeyPath<Element, T>) -> [T: Element] {
